...
//https://services.arcgis.com/P3ePLMYs2RVChkJx/ArcGIS/rest/services/ACS_Household_Income_Distribution_Boundaries/FeatureServer
...
// repository for american community survey services: https://services.arcgis.com/P3ePLMYs2RVChkJx/ArcGIS/rest/services 
  ...
  // Creating a feature layer from my Household Income URL
  var HouseholdIncomeUrl = "https://services.arcgis.com/P3ePLMYs2RVChkJx/ArcGIS/rest/services/ACS_Household_Income_Distribution_Boundaries/FeatureServer"
  const HouseholdIncomeLayer = new FeatureLayer({
    url:HouseholdIncomeUrl, 
    title: "Household Income Distribution", 
  });
    
//Making a function to exectute query
var loadAdditionalData =function(){
  ////Creating a new query object and giving it correct properties 
  let additionalQuery = HouseholdIncomeLayer.createQuery();
  additionalQuery.returnGeometry = false;
  additionalQuery.outFields = "*"
  ////execute query on your new layer
 HouseholdIncomeLayer.queryFeatures(additionalQuery).then(function(r){
console.log(r)
r.features.forEach(function(feature){
  ...
  if(feature.attributes['STUSPS'] != "DC"){
      ...
      var income = feature.attributes['B19001_013M']
    
      stateObj[stateName]['HouseholdIncome'] = income
  }
